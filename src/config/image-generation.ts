...
import { addSwarmUIGenerationTool } from "../cloud-api/local/swarmui-image-generation";
...
switch (imageGenerationServer) {
  ...
  case ImageGenerationServer.volcengine:
    ...
    break;
  case ImageGenerationServer.swarmui:
    addSwarmUIGenerationTool(imageGenerationTools);
    break;
  default:
    break;
}
